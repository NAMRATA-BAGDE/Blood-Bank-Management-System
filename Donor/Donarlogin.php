<html>
    ...
    <nav class="navbar">
        ...
        <form action="LOGIDon.php">
            <div class="con">
                <center>
                <p class="a">Donar Login Page</p><br>
                <p class="b">Donar Name :</p><input type="text" name="b1" ><br>
                <p class="b">Password :</p><input type="text" name="b2"><br><br>
                <input type="submit" class="but"  value="LOGin"><br>
                <span>if u don't have account ?<a href="DonarReg.php">Register</a></span>
                </center>
            </div>    
        </form>
        <footer>
