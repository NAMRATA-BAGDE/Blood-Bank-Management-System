    ...
    <div class="main">
        <div class="content">
            <form action="P-editDB.php">
                ...
                $id = $_GET['id'];
                $con = mysqli_connect('localhost', 'root', '', 'bloodbank');
                $query = "Select * from patient_info where id = '$id'";
                $result = mysqli_query($con, $query);
                while ($row = mysqli_fetch_array($result)) {
                    echo "
                            <p>Update Page</p>
                            ...
                            <input type='text' name='t1' value='$row[patient_name]' class='td'><br><br>
                            <span  class='txt'>Email ID :</span><br>
                            <input type='text' name='t2' value='$row[patient_email]' class='td'><br><br>
                            <span  class='txt'>Password :</span><br>
                            <input type='text' name='t3' value='$row[password]' class='td'><br><br>
                            <span  class='txt'>Mobile No. :</span><br>
                            <input type='text' name='t4' value='$row[patient_mobile]' class='td'><br><br>";
                }
                ?>
